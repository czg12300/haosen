...
public class MySimpleAdapter extends SimpleAdapter {
    ...
    private List<Map<String, Object>> mEvent;
    ...
    public MySimpleAdapter(Context context,
                           ...
                           int[] to, List<Map<String, Object>> eventList) {
    ...
    private void bindView(int position, View view) {
        ...
        final int[] to = mTo;
        final List<Map<String, Object>> eventList = mEvent;
        final int count = to.length;
            ...
            if (v != null) {
                ...
                try {
                    if (eventList.get(i) != null) {
                        if (eventList.get(i).get("event").toString().toLowerCase() == "onclick") {
                            v.setOnClickListener((View.OnClickListener) eventList.get(i).get("listener"));
                        }
                        v.setTag(position);
                    }
                } catch (Exception e) {
...
//                    	setViewImage((ImageView) v,"http://timg3.ddmapimg.com/city/images/citynew/2696c2126e903cf8d-7f23.jpg");
    ...
    // �洢�Ѿ����ص�ͼƬ
    HashMap<String, Bitmap> loadedImage = new HashMap<String, Bitmap>();

    // int loadcount=0;
    public void setViewImage(ImageView v, String value) {
        Bitmap bitmap;
        if (loadedImage.containsKey(value))
            bitmap = loadedImage.get(value);
        else {
            bitmap = WebImageBuilder.returnBitMap(value);
            loadedImage.put(value, bitmap);
            // loadcount++;
            // System.out.println("load image:"+ loadcount);
        }
        ((ImageView) v).setImageBitmap(bitmap);
